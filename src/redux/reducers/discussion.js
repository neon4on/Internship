  ...
  switch (action.type) {
    ...
    case FETCH_DISCUSSION_SUCCESS:
      if (action.payload.page !== 1) {
        ...
        items = {} // Without this line we get an error: 'A state mutation was detected inside a dispatch'
        items[action.payload.id] = JSON.parse(
          JSON.stringify(action.payload.discussion)
        )
      }
